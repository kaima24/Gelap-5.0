...
import { Upload, Sparkles, Download, RefreshCw, AlertCircle, Image as ImageIcon } from 'lucide-react';
...
const ToolInterface: React.FC<ToolInterfaceProps> = ({ tool }) => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const generatedImageBase64 = await generateCreativeImage(finalPrompt, imageBase64);
  ...
  return (
    <div className="flex flex-col h-full max-w-6xl mx-auto p-4 md:p-8 space-y-8 animate-fade-in">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-full">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 shadow-sm backdrop-blur-sm">
            ...
            <div className="mb-6">
               ...
               <div 
                 ...
                 className={`
                   relative group cursor-pointer border-2 border-dashed rounded-lg h-48 flex flex-col items-center justify-center transition-all duration-300
                   ${previewUrl ? 'border-zinc-700 bg-zinc-900' : 'border-zinc-800 hover:border-zinc-600 hover:bg-zinc-900/80'}
                 `}
               >
                 {previewUrl ? (
            ...
            <div className="mb-6">
              ...
              <textarea 
                ...
                className="w-full bg-zinc-950 border border-zinc-800 rounded-lg p-4 text-zinc-200 text-sm focus:outline-none focus:ring-1 focus:ring-zinc-600 min-h-[140px] resize-none placeholder-zinc-700"
              />
            </div>
            ...
            {error && (
              <div className="mt-4 p-3 bg-red-900/20 border border-red-900/50 rounded-lg flex items-start gap-3 text-red-400 text-sm">
        ...
        <div className="lg:col-span-8">
           <div className="h-full bg-zinc-900/30 border border-zinc-800/50 rounded-xl flex items-center justify-center relative overflow-hidden backdrop-blur-sm min-h-[500px]">
             {resultImage ? (
               <div className="relative w-full h-full flex items-center justify-center bg-black/40">
                 ...
                 <div className="absolute bottom-6 right-6 flex gap-3">
                    <button 
                      ...
                      className="bg-black/80 hover:bg-black text-white p-3 rounded-full backdrop-blur-md border border-zinc-800 transition-colors"
                      title="Download"
                    >
                      <Download size={20} />
                    </button>
               ...
               <div className="text-center p-8">
                 {isGenerating ? (
                   ...
                   <div className="flex flex-col items-center text-zinc-700">
                     <div className="w-20 h-20 bg-zinc-900/80 rounded-full flex items-center justify-center mb-4 border border-zinc-800">
                       <ImageIcon size={32} />
                     </div>
